...
let album1 = makealbum("atif Aslam" , "Doori")
console.log(album1)

let album2 =  makealbum("Kaif Khalil", "Kahani suno") 
console.log(album2)

let album3 = makealbum("Ayesha", "typescript")
console.log(album3)

let album4 = makealbum("Usman", "Black")
console.log(album4)
